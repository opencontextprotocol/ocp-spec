...
# Version configuration for OCP
# MAIN_VERSION format: "ref:display_name:source_dir" - this is what serves at the root
# VERSIONS format: "ref:display_name:source_dir" - these serve at /versions/{display_name}/
MAIN_VERSION="v1.0.0:v1.0:docs"
VERSIONS=(
  "main:latest:docs"  # Development preview at /versions/latest/
)
