...
def create_ide_agent(
    ...
    """Create an AgentContext optimized for IDE coding assistants."""
    return AgentContext(
...
def create_debug_agent(
    ...
    """Create an AgentContext optimized for debugging workflows."""
    ...
    context.set_error_context(error, file_path)
    return context
...
def create_devops_agent(
    ...
    """Create an AgentContext optimized for DevOps workflows."""
    context = AgentContext(
        agent_type="devops_agent",
        workspace=workspace,
        current_goal="infrastructure_management",
    )
    if environment:
        context.session["environment"] = environment
    return context